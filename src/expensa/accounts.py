...
``~/.expensa/``. Multi-account support introduces a small
...
DEFAULT_GLOBAL_HOME = Path("~/.expensa").expanduser()
...
class AccountRegistry:
    ...
    The on-disk format::
        ...
        accounts:
          - id: default
            name: Default
            data_dir: /home/u/.expensa
          - id: business
            name: Business
            data_dir: /home/u/.expensa/accounts/business
