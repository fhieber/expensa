...
from expensa.config import packaged_default_categories
from expensa.ml import embedding_viz_cache
from expensa.ml.embedding_viz import project_labeled_embeddings
from expensa.storage.admin import category_removal_impact, remove_category
...
from expensa.storage.stats import category_stats, uncategorized_stat
from expensa.ui._components import chart_expander
from expensa.ui._shared import (
    get_active_account,
    get_config,
    get_conn,
)
from expensa.utils.colors import random_hex_color
from expensa.viz import category_embedding_scatter
