...
def _migrate_v5(conn: sqlite3.Connection) -> None:
    ...
    from expensa.ingestion.normalizer import combined_text as _ct
    from expensa.ingestion.normalizer import normalize_counterparty as _ncp
    from expensa.ingestion.normalizer import normalize_verwendungszweck as _nvz
